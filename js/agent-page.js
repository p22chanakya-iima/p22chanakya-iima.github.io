...
/* WebMCP tool registration now lives in js/webmcp-tools.js, loaded on every
   page (root-relative paths) so in-browser agents can discover it no matter
   which page they land on, not just here. */
